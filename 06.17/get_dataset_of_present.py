...
esportsPlayerId_type_dict = dict(zip(temp1, temp2))
strcolumn_dict.update(esportsPlayerId_type_dict)
last_row_of_collected_datas_df = pd.read_excel("../data/last_row_of_collected_datas.xlsx", dtype = strcolumn_dict)  # strcolumn_dict -> 특정 열의 이름과 그 열의 데이터 타입을 딕셔너리 형태로 지정하는 방식
